...
% TODO formalize useless
Somewhat more formally we say a expert is useless if knowing their signal would not change the chosen action for any possible set of other agents signals (including the empty set, i.e. the prior).
This motivates considering the VCG style mechanisms.
