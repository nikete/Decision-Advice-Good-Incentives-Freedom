...
\[
  \rho_i  = \alpha \pi_i
\]
\ND{Initiall I tried instead of just a multiplier < 1, having a gneeral function g with g(0) = 0, and g is monotonically increasing in $pi_i$. But this doesnt work if you lower the negatives more than the positive for example you fuck up the payments.
}

The value of $\alpha$ can be chosen apriori based on $P$ such that: $ E[\sum \rho_i] < E[r|c(s,P)] - E[r|c(P)] $ . 

\NDP{This seems like it should be just algebra, for exmaple if aprior I expect 10 complementary signals which combined produce a expected surplus of 1 then i want to have $g = \alpha pi$ and \alpha < 1/10. How can we make this procedure generic? }
