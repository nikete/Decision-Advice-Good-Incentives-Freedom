...
\begin{defn}[maximizers or allways takers]: assuming that all subjects are either utility maximizers (compliers under a efficient mechanism) or have some action they will take irrespective of the reports of the experts (always takers or never takers in the binary setting). 
\end{defn}
...
If the expert has the highest bid, then their signal report becomes irrelavant, as they already know their true signal. % soo.... ???
