...
We now consider a setting where the experts submit their signals, however, unlike in the .
 While we saw that there was a revelating equilibrium, the mechanism failed the property of paying for useless experts. We show that the repeated nature of the problem can be used to overcome payments to useless experts. \DBA{I wonder vaguely about whether there is some tradeoff between simple mechanisms that overpay and complicated mechanisms (with other potential problems) that don't}
