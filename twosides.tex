...
%  A major concern is that an expert would not reveal their signal truthfully and lose out on that part of the reward if they can benefit more from being the \emph{owner}, and by withholding their signal they can suppress the bids of other experts; this is a particular concern since the other experts may be able to achieve higher rewards.
